...
/**
 * Owner / offline fallbacks for the Raj Kumar Ghalan portfolio.
 * Production CMS rows remain the source of truth when present.
 * Customer sites never write these values onto the owner site_id.
 */
...
export function defaultSections(): SectionRow[] {
  return [
    ...
    },
    {
      ...
      href: "#market",
      title: "Market",
      description: "NEPSE market analysis spotlight.",
      visible: true,
      sort_order: 40,
    },
    {
...
export function defaultProductSettings(): ProductSettingsRow {
  return {
    ...
    case_title: "FIRE Nepal, in focus",
    case_eyebrow: "04 / Case study",
    live_url: projects.fireNepal.href,
    category: projects.fireNepal.category,
    short_description: projects.fireNepal.description,
    problem_title: "The Problem",
    problem_body:
      "Many people struggle to understand their complete financial picture — savings progress, investments, retirement needs, and the long path to financial independence.",
    vision_title: "The Vision",
    vision_body:
      "Build one practical financial platform designed around the financial realities of Nepalis — at home and abroad.",
    built_title: "What I Built",
    built_body:
      "I approached FIRE Nepal as a product, not a demo: a connected set of tools for wealth, cashflow, savings, business, and guidance — designed to be used on a phone after work.",
    ...
    philosophy_body: "Technology should simplify financial decisions, not make them harder.",
    technologies: [...projects.fireNepal.technologies],
    visible: true,
    sort_order: 0,
  };
